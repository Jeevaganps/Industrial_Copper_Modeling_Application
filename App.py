...
<div style='text-align:center'>
    <h1 style='colour:#000000;'>Industrial Copper Modeling Application</h1>
</div>
...
with tab1:    
        ...
        # Define the possible values for the dropdown menu
        ...
        with st.form("my_form"):
            ...
            with col3:               
                st.write( f'<h5 style="colour:RAL 9005;">NOTE: Min & Max given for reference, you can enter any value</h5>', unsafe_allow_html=True )
...
st.write( f'<h6 style="colour:RAL 9005;">App Created by jeevagan</h6>', unsafe_allow_html=True )  
